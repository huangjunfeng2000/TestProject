...
bool FfmpegManager::closeVideoStream (AVFormatContext *oc, AVStream *st)
{
	//assert(false);
	return false;
}

bool FfmpegManager::closeAudioStream (AVFormatContext *oc, AVStream *st)
{
	//assert(false);
	return false;
}

AVFrame *FfmpegManager::allocFrameMemmory (enum PixelFormat pix_fmt, int width, int height)
{
	return NULL;
}
void FfmpegManager::getAudioFrame (int16_t *samples, int frame_size, int nb_channels)
{
